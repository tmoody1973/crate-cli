...
- **search_reviews** — Search 23 music publications (Pitchfork, The Quietus, Resident Advisor, Stereogum, BrooklynVegan, FACT, NME, NPR, The Guardian, Bandcamp Daily, AllMusic, The Wire, The FADER, Aquarium Drunkard, Boomkat, and more) for album/artist reviews. Optionally extract full review text for deeper analysis. When Exa is available and initial results are sparse, automatically discovers additional related reviews via semantic similarity.
